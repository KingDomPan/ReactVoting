...
class Home extends React.Component {
    ...
    handleClick(character) {
        ...
        var loser = first(without(this.state.characters, findWhere(this.state.characters, {character: winner}))).characterId;
            ...
            return (
                <div key={character.characterId}
                    ...
                    <div className='thumbnail fadeInUp animated'>
                        <img onClick={this.handleClick.bind(this, character)}
                             src={'http://image.eveonline.com/Character/' + character.characterId + '_512.jpg'}/>
